---
layout: post
title: "IA generativa nel banking: Conto alla rovescia per la conformità fino ad agosto 2026"
date: 2026-03-20
categories: [sostenibilita]
tags: ["ia-compliance", "eu-ai-act", "dora", "settore-finanziario", "regolamentazione", "sostenibilita", "verdantis"]
author: "Dirk Roethig, CEO, VERDANTIS Impact Capital"
lang: it
published: true
description: "Dirk Röthig spiega come DORA, l'EU AI Act e il CRR III stanno ridefinendo la conformità della GenAI nel settore bancario entro agosto 2026 — con un quadro operativo per i CRO."
---
...
- [IA nelle PMI: Come calcolare il ROI — Benchmark settoriali 2026](https://dev.to/dirkroethig-verdantis/ki-im-mittelstand-roi-richtig-berechnen-sektor-benchmarks-2026-4e6p) — Modelli strutturati di calcolo del ROI per CFO e controller
- [Cambiamento demografico e IA — Automazione contro la carenza di manodopera 2026](https://dev.to/dirkroethig-verdantis/demografischer-wandel-und-ki-automatisierung-gegen-arbeitskraftemangel-2026-11p7) — Come l'IA attenua la pressione demografica nella quotidianità aziendale
- [Biodiversità in agricoltura — Consociazioni e agroforestazione come approccio risolutivo](https://dev.to/dirkroethig-verdantis/biodiversitat-in-der-landwirtschaft-mischanbau-und-agroforst-als-losungsansatz-5gg8) — Strategie per l'agricoltura rigenerativa e i crediti di carbonio
